...
const unsigned char rconst[11] = {
    0x8d, 0x01, 0x02, 0x04, 0x08, 0x10, 0x20, 0x40, 0x80, 0x1b, 0x36};

const unsigned char get_r_const(unsigned char ch)
{
    return rconst[ch];
}

const unsigned char get_s_box(unsigned char ch)
{
    return sbox[ch];
}

const unsigned char get_rs_box(unsigned char ch)
{
    return rsbox[ch];
}
