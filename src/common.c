...
unsigned char rconst[11] = {
    0x8d, 0x01, 0x02, 0x04, 0x08, 0x10, 0x20, 0x40, 0x80, 0x1b, 0x36};
    
const unsigned char E[16][16] = {
...
unsigned char gf_mult(unsigned char a, unsigned char b) {
    ...
    unsigned char l_a = L[(a >> 4) & 0x0F][a & 0x0F];
    unsigned char l_b = L[(b >> 4) & 0x0F][b & 0x0F];
    
    unsigned short s = l_a + l_b;
    if (s > 0xff) s -= 0xff;
    
    return E[(s >> 4) & 0x0F][s & 0x0F];
}
